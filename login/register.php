...
if (isset($_POST['signup'])) {
    ...
    if ($count == 0) { // if email is not found add user
        ...
        $stmts = $conn->prepare("INSERT INTO users(username,email,password,rank,hash) VALUES(?, ?, ?, ?, ?)");
        $stmts->bind_param("sssss", $uname, $email, $password, $defaultrank, $hash);
        ...
        <form method="post" autocomplete="off">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <h2 class="">Register for GZGhost</h2>
                </div>
