<nav class="navbar navbar-inverse bg-inverse navbar-fixed-top navbar-expand-sm">
  <div class="container-fluid">
    <ul class="nav navbar-nav navbar-left">
      <li><a href="https://www.gzghost.me/">Home</a></li>
    ...
    <?php if (isset($_SESSION['user']))  {
        echo '<ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="https://www.gzghost.me/user/dashboard"><span class="glyphicon glyphicon-dashboard"></span>&nbsp;Dashboard</a></li>
                        <li><a href="https://www.gzghost.me/login/logout.php?logout"><span class="glyphicon glyphicon-log-out"></span>&nbsp;Logout</a>
                        </li>
                    </ul>';
                  } else {
                    echo '
    <ul class="nav navbar-nav navbar-right">
      <li class="active"><a href="https://www.gzghost.me/login/register.php"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
